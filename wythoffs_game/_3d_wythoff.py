"""
Generates and displays Instant-Winner and Loser sheets for 3D Wythoff: Normal 3-heap Nim, but an 
additional move is introduced: to take away the same number of chips from any two piles.
"""
...
def main():
    ...
    # Initialize Ax, Bx, and Cx as all 0s.
    # Ax = x reduction, Bx = x,y reduction, Cx = x,z reduction
    ...
    Wx = generate_Wx(Ax, Bx, Cx, desired_level)
...
@njit
def generate_Wx(Ax, Bx, Cx, desired_level):
